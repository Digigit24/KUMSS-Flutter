...
class CollegesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final colleges = [
      ['College of Engineering', 'COE', 'Engineering', '3,240', true],
      ['College of Medicine', 'COM', 'Medicine', '2,180', true],
      ['College of Business', 'COB', 'Business', '2,850', true],
      ['College of Law', 'COL', 'Law', '1,420', true],
      ['College of Science', 'COS', 'Science', '2,768', false],
    ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          PageHeader(
            ...
            actions: [
              AppButton(
                ...
                onPressed: () => _showCollegeDialog(context),
              ),
            ],
          ),
          // Stats row
          Row(
            children: [
              _buildStat('Total Colleges', '5', Icons.apartment_rounded, AppColors.accent),
              const SizedBox(width: 16),
              _buildStat('Active', '4', Icons.check_circle_rounded, AppColors.success),
              const SizedBox(width: 16),
              _buildStat('Inactive', '1', Icons.pause_circle_rounded, AppColors.textTertiary),
              const SizedBox(width: 16),
              _buildStat('Total Students', '12,458', Icons.people_rounded, AppColors.info),
              ...
              return [
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(c[0] as String, style: AppTypography.labelLarge),
                    ),
                  ],
                ),
