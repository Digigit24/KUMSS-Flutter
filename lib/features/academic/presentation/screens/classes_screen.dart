...
class ClassesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final classes = [
      ['B.Tech CSE - Year 1', 'B.Tech CS', '2025-26', '3', '180'],
      ['B.Tech CSE - Year 2', 'B.Tech CS', '2024-25', '3', '175'],
      ['B.Tech CSE - Year 3', 'B.Tech CS', '2023-24', '3', '168'],
      ['B.Tech CSE - Year 4', 'B.Tech CS', '2022-23', '2', '155'],
      ['MBA - Year 1', 'MBA', '2025-26', '2', '120'],
      ['MBA - Year 2', 'MBA', '2024-25', '2', '115'],
      ['MBBS - Year 1', 'MBBS', '2025-26', '2', '90'],
    ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          PageHeader(
            title: 'Classes',
            subtitle: 'Set up class batches and year groups',
            breadcrumbs: const ['Home', 'Academic', 'Classes'],
