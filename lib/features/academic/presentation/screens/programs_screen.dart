...
class ProgramsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final programs = [
      ['B.Tech Computer Science', 'Computing', '4 Years', '820', true],
      ['B.Tech Mechanical', 'Civil', '4 Years', '640', true],
      ['MBBS', 'Clinical Sciences', '5.5 Years', '450', true],
      ['MBA', 'Management', '2 Years', '380', true],
      ['BBA', 'Management', '3 Years', '520', true],
      ['LLB', 'Criminal Law', '5 Years', '280', true],
      ['B.Sc Physics', 'Natural Sciences', '3 Years', '360', false],
    ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          PageHeader(
            title: 'Programs',
            subtitle: 'Manage degree and diploma programs',
            breadcrumbs: const ['Home', 'Academic', 'Programs'],
