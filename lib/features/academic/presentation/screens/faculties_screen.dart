...
class FacultiesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final faculties = [
      ['Faculty of Computing & Informatics', 'Engineering', 'Dr. Abebe Kebede', '4', true],
      ['Faculty of Clinical Sciences', 'Medicine', 'Dr. Sara Tadesse', '3', true],
    ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        AppDataTable(
          ...
          totalItems: faculties.length, onSearch: (_) {},
        ),
      ]),
    );
  }
