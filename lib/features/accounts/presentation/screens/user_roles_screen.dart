...
class UserRolesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final assignments = [
      ['Dr. Rahul Sharma', 'Teacher', 'Engineering', true, 'Never'],
      ['Priya Patel', 'College Admin', 'Medicine', true, 'Never'],
      ['Amit Kumar', 'Accountant', 'All Colleges', true, 'Never'],
      ['Sneha Gupta', 'Student', 'Business', true, 'May 2027'],
      ['Rajesh Singh', 'Clerk', 'Law', false, 'Dec 2026'],
      ['Maya Devi', 'Teacher', 'Science', true, 'Never'],
      ['Vikram Joshi', 'Clerk', 'Engineering', true, 'Never'],
    ];
      ...
      child: Column(
        ...
        children: [
          PageHeader(
            ...
            subtitle: 'Map users to roles with college-level scoping',
            breadcrumbs: const ['Home', 'Accounts', 'User Roles'],
            actions: [
              AppButton(
                label: 'Assign Role',
          ...
          AppDataTable(
            ...
            rows: assignments.map((a) {
              return [
                ...
                Icon(
                  (a[3] as bool) ? Icons.star_rounded : Icons.star_border_rounded,
                  size: 18,
                  color: (a[3] as bool) ? AppColors.secondary : AppColors.textTertiary,
                ),
